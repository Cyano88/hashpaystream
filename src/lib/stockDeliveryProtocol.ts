...
export const AGREEMENT_BACKED_STOCK_DELIVERY_ABI = parseAbi([
  ...
  'function paused() view returns (bool)', 'function arcRepaymentRouter() view returns (address)', 'function underwritingSigner() view returns (address)', 'function riskSigner() view returns (address)', 'function protectionSigner() view returns (address)',
  'function allowedFunders(address) view returns (bool)', 'function allowedStockAssets(address) view returns (bool)',
...
export const STOCK_DELIVERY_TOKEN_ABI = parseAbi(['function approve(address spender,uint256 amount) returns (bool)', 'function allowance(address owner,address spender) view returns (uint256)', 'function balanceOf(address owner) view returns (uint256)', 'function decimals() view returns (uint8)', 'function symbol() view returns (string)'])
