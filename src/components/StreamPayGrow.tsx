  ...
  return (
    <section className="stream-screen min-h-[calc(100dvh-6rem)] w-full max-w-md pb-28 pt-7">
      <header className="flex items-center gap-3">
        ...
        <div><h1 className="text-xl font-black tracking-tight">Earn</h1><p className="mt-0.5 text-[11px] text-zinc-500 dark:text-zinc-400">Fund eligible worker stock payments on X Layer.</p></div>
      </header>
