...
export default function StreamPayAccount() {
  ...
  const earlierWalletTo = useStreamPayPath('/account/earlier-wallet')
  ...
  return <section className="stream-screen w-full max-w-md py-5 sm:py-8">
    ...
    <div className="stream-list-card overflow-visible">
      ...
      <HostedAccountConnection /><Link to={earlierWalletTo} className="flex min-h-12 items-center border-t border-gray-100 px-4 text-xs text-gray-500 dark:border-white/10">Earlier stock wallet</Link>
