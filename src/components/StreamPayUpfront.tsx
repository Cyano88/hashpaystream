    ...
    <section className="w-full max-w-3xl py-8 sm:py-12">
      ...
      <form onSubmit={submit} className="mt-8 rounded-3xl border border-gray-200 bg-white p-5 dark:border-white/10 dark:bg-[#18181b] sm:p-8">
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <label className="text-xs font-semibold text-gray-700 dark:text-gray-300">Protection period<select className={inputClass} value={durationSeconds} disabled><option value={7200}>2 hours</option><option value={86400}>1 day</option><option value={259200}>3 days</option><option value={604800}>7 days</option><option value={2592000}>30 days</option></select></label>
          <label className="text-xs font-semibold text-gray-700 dark:text-gray-300">Early cancellation<select className={inputClass} value={cancellationWindowSeconds} disabled><option value={0}>None</option><option value={900}>15 minutes</option><option value={3600}>1 hour</option></select></label>
