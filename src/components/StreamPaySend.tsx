...
export default function StreamPaySend() {
  ...
  return <section className="w-full max-w-md py-5 sm:py-8">
    <div className="flex items-center gap-3"><Link to={homeTo} aria-label="Back home" className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-gray-700 shadow-sm dark:bg-white/[0.06] dark:text-white"><ArrowLeftIcon className="h-4 w-4" /></Link><div><h1 className="text-xl font-extrabold tracking-tight text-gray-950 dark:text-white">Send Arc USDC</h1><p className="text-[11px] text-gray-400">Arc Testnet</p></div></div>
    <div className="mt-5 space-y-4 rounded-[26px] border border-gray-100 bg-white p-5 shadow-sm dark:border-white/[0.07] dark:bg-white/[0.035]">
