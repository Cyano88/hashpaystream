...
function statusLabel(status: ServiceRequest['status']) { return ({ sent: 'Waiting for worker', countered: 'New terms proposed', provider_accepted: 'Worker accepted', awaiting_funding: 'Ready to fund', funded: 'Funded', declined: 'Declined', cancelled: 'Cancelled' } as const)[status] }
