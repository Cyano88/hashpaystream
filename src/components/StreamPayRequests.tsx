...
function Duration({ value, onChange }: { value: string; onChange: (value: string) => void }) { return <StreamSelect label="Delivery period" value={value} onChange={onChange} options={[{ value: '3600', label: '1 hour' }, { value: '86400', label: '1 day' }, { value: '259200', label: '3 days' }, { value: '604800', label: '7 days' }, { value: '2592000', label: '30 days' }]} /> }
