...
export default function StreamPayNotifications() {
  ...
  return <section className="w-full max-w-md py-5 sm:py-8">
    <div className="flex items-center gap-3"><Link to={homeTo} className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-gray-600 shadow-sm dark:bg-white/[0.06] dark:text-white" aria-label="Back home"><ArrowLeftIcon className="h-4 w-4" /></Link><h1 className="text-xl font-extrabold tracking-tight text-gray-950 dark:text-white">Notifications</h1></div>
