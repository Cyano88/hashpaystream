...
export type StockReference={observedAt:number;expiresAt:number;spyUsdE8:bigint;usdcUsdE8:bigint;volatilityBps:number;fiveMinuteMoveBps:number;sessionOpen:number;sessionClose:number;source:'alpaca-sip+kraken'|'pyth-pro'|'twelve-data'}
