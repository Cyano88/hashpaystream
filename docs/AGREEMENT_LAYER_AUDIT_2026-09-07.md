...
- App/server/Android contract bindings now agree; the upstream signer uses escrow domain version 2. Android 1.0.18 is installed on the Pixel. Deployment evidence is in contracts/deployments/reviewed-rehearsal-20260907.json; prior records are preserved under deployments/history.
...
2. The isolated funding, split, refund and worker disk-journal recovery walkthrough passed on 2026-09-08; see AGREEMENT_WALKTHROUGH_2026-09-08.md. Complete the separately authorized external funding, delivery/review, split/refund and retry walkthrough. Verify exact funder/provider/platform amounts, single execution, receipt export and wallet flows.
