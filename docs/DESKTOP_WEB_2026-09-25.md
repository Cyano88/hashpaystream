...
Desktop sign-in calls the existing Privy email login modal. Mobile retains StreamPayEmailLogin. Privy provider identity, wallet creation, signing, sessions and API permissions are unchanged.
