...
const checks=[['/healthz',200],['/api/hashpaystream/v1/trade/listings',200],['/api/hashpaystream/v1/trade/conversations',401],['/api/hashpaystream/v1/trade/moderation',401],['/api/hashpaystream/v1/service-requests',401]];
let failed=false;
