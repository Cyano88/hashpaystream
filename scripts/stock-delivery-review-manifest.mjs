...
const files = [
  '.env.example',
  '.gitattributes',
  '.github/workflows/stock-delivery-release.yml',
  ...
  'contracts/audits/AGREEMENT_BACKED_STOCK_DELIVERY_REVIEW_2026-09-14.md',
  'contracts/hardhat.config.ts',
  'contracts/package-lock.json',
  'contracts/package.json',
  'contracts/scripts/assert-reviewed-build.ts',
  'contracts/scripts/assert-reviewed-stock-delivery.ts',
  'contracts/scripts/create-stock-owner-safe-mainnet.ts',
  'contracts/scripts/deploy-stock-delivery-mainnet.ts',
  'contracts/scripts/plan-stock-owner-safe-mainnet.ts',
  'contracts/scripts/stock-owner-safe-plan.ts',
  'contracts/scripts/verify-stock-delivery-mainnet.ts',
  'contracts/scripts/verify-stock-owner-safe-mainnet.ts',
  'contracts/scripts/verify-stock-owner-safe.ts',
  'contracts/src/AgreementBackedStockDelivery.sol',
  'contracts/test/AgreementBackedStockDelivery.test.ts',
  'contracts/test/StockDeliveryDeploymentGuards.test.ts',
  'contracts/test/StockOwnerSafePlanning.test.ts',
  'contracts/test/StockOwnerSafeVerification.test.ts',
  'docs/STOCK_DELIVERY_EXTERNAL_REVIEW_PACKET_2026-09-14.md',
  'docs/STOCK_OWNER_SAFE_RUNBOOK_2026-09-14.md',
  'docs/evidence/stock-paused-deployment-plan.json',
  'docs/evidence/stock-owner-safe-policy.json',
  'docs/evidence/stock-owner-safe-planner-rehearsal.json',
  'docs/evidence/stock-xlayer-candidate.json',
  'package-lock.json',
  'package.json',
  'render.yaml',
  'scripts/stock-delivery-offers-smoke.mjs',
  'scripts/stock-delivery-review-manifest.mjs',
  ...
  'scripts/stock-paused-deployment-plan.mjs',
