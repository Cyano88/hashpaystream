...
assert.match(agreementHome, /Currently protected/)
...
assert.match(app, /const AUTH_DECISION_ROUTES = new Set\(\['\/', '\/home', '\/agreements', '\/agreements\/new', '\/upfront', '\/funding', '\/activity', '\/account', '\/operations', '\/admin\/analytics'\]\)/)
