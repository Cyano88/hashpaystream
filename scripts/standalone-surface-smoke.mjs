...
assert.match(growPage, /Savings and private funding remain separate products/)
...
assert.match(savingsPage, /X Layer savings in security review/)
assert.match(savingsPage, /Savings networks/)
assert.match(savingsPage, /Save early-pay earnings/)
assert.match(savingsPage, /Save agreement earnings/)
assert.match(savingsPage, /Coming soon/)
assert.match(savingsPage, /No platform withdrawal access/)
assert.match(savingsPage, /Scheduled releases/)
...
assert.match(savingsPage, /label='Network' value='X Layer'/)
assert.doesNotMatch(savingsPage + growPage + homeBalanceCarousel, /Yield earned|yield rate|Jupiter Lend|Savings rewards/i)
assert.match(savingsDeposit, /Approve USDC - Step 1 of 2/)
assert.match(savingsDeposit, /Start savings - Step 2 of 2/)
assert.match(savingsDeposit, /Emergency access has a 48-hour delay/)
