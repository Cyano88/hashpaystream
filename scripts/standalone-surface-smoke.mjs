...
assert.match(fundingDesk, /completed \? 'You funded' : 'You fund'/)
assert.match(fundingDesk, /completed \? 'You received' : 'You receive'/)
assert.match(fundingDesk, /completed \? 'Profit earned' : 'Your profit'/)
