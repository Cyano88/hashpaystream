...
assert.match(fundingDesk, /Your funding/)
...
assert.match(growPage, /Grow Balance/)
assert.match(growPage, /Stablecoin Yields/)
assert.match(growPage, /JupUSD/)
assert.match(growPage, /USDC/)
assert.match(growPage, /No Lockups/)
assert.match(growPage, /Illustrative compound growth/)
assert.match(growPage, /Deposit into/)
assert.match(growPage, /No yield is guaranteed/)
assert.match(growPage, /No funds were moved/)
