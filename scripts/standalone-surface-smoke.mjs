...
assert.match(agreementHome, /Arc wallet/)
...
assert.match(mobileNav, /Activity/)
...
assert.match(sendPage, /waitForTransactionReceipt/)
assert.match(sendPage, /recordTransfer/)
assert.match(receivePage, /Pocket ID/)
assert.match(receivePage, /Arc address/)
