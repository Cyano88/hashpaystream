...
assert.match(savingsPage, /X Layer vaults in security review/)
...
assert.match(savingsPage, /Locked savings/)
assert.match(savingsPage, /30–365 days/)
assert.match(savingsPage, /5% early-exit penalty/)
assert.match(savingsPage, /Rewards cannot exceed 5% of what you keep locked/)
