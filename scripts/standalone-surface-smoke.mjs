...
assert.match(upfrontPage, /Approved for up to \{approvedAmount\} USDC/)
assert.match(upfrontPage, /Waiting for an approved funding partner/)
...
assert.match(fundingDesk, /Funding opportunities/)
assert.match(fundingDesk, /Open agreements/)
assert.match(fundingDesk, /Your positions/)
...
assert.match(treasuryWallet, /Funding balance/)
...
assert.doesNotMatch(treasuryWallet, /Add funds|>Refresh<\/button>/)
...
assert.match(growPage, /Funding opportunities/)
...
assert.match(treasuryWallet, /Repayments settle on Arc/)
