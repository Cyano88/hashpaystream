...
assert.match(fundingDesk, /Open opportunities/)
assert.match(fundingDesk, /Your funding/)
assert.match(fundingDesk, /deployedUsdcUnits/)
assert.match(fundingDesk, /Public test: customer protection is test USDC on Arc/)
...
assert.match(treasuryWallet, /X Layer funding balance/)
assert.match(treasuryWallet, /Active positions/)
...
assert.match(treasuryWallet, /Repayments settle separately on Arc/)
