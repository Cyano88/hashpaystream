...
assert.match(requestsPage, /providerCanCheckEarlyPay/)
...
assert.match(server, /startUpfrontSettlementWorker\(\)/)
assert.match(server, /triggerSettlement: upfrontSettlementWorker\.trigger/)
assert.match(server, /upfrontSettlementWorker\.stop\(\)/)
...
assert.match(fundingPartnerPicker, /\['pending', 'funded'\]\.includes\(selection\.status\)/)
