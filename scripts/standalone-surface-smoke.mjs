...
assert.match(growPage, /Returns are variable and never guaranteed/)
...
assert.match(savingsPage, /Savings vault in security review/)
assert.match(savingsPage, /Yield is separate/)
