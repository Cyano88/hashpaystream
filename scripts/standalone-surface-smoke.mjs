...
const architectureDocs = read('src/components/docs/StreamPayArchitectureDocs.tsx')
...
assert.match(docsShell, /RectangleGroupIcon/)
assert.match(docsShell, /path: '\/docs\/architecture'/)
assert.match(architectureDocs, /uses Hash PayLink APIs exclusively/)
assert.match(architectureDocs, /from '@heroicons\/react\/24\/outline'/)
