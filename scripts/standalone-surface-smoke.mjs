...
assert.match(agreementHome, /Balance unavailable\. Tap to retry\./)
...
assert.match(payoutWallet, /aria-label="Create X Layer payout wallet"/)
assert.match(payoutWallet, /disabled=\{creating\}/)
assert.match(payoutWallet, /min-h-11 w-full/)
