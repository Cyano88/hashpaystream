...
assert.match(fundingDesk, /Funding execution remains operator-controlled during the pilot/)
...
assert.deepEqual([...new Set(viteNames)].sort(), ['VITE_HASHPAYSTREAM_UPFRONT_ARC_ROUTER_ADDRESS', 'VITE_HASHPAYSTREAM_UPFRONT_CHAIN_ID', 'VITE_HASHPAYSTREAM_UPFRONT_ENABLED', 'VITE_HASHPAYSTREAM_UPFRONT_TREASURY_ENABLED', 'VITE_HASH_PAYLINK_BASE_URL', 'VITE_PRIVY_APP_ID'])
