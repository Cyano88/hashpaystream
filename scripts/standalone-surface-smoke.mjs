...
assert.match(mobileNav, /rounded-full/)
...
assert.match(savingsPage, /!savings\.configReady \|\| !savings\.savingsReady/)
...
assert.match(app, /<StreamPayLoadingState active=\{loadingSurface\(route\)\}/)
assert.doesNotMatch(app, /<LoadingRing/)
assert.match(
  app,
  /<SessionLoadingSurface route=\{route\} sessionDelayed=\{false\} onRetry=\{retrySession\} \/>[\s\S]*<HashPayStreamSessionSplash/,
...
assert.match(circleWalletGate, /stage === 'restoring'[\s\S]*<StreamPayLoadingState/)
