...
assert.equal(assessmentCalls[0].schemaVersion, '2.0.0')
assert.equal(assessmentCalls[0].source.environment, 'hybrid')
...
assert.equal(assessmentCalls[0].advance.fundingNetwork, 'x-layer-mainnet')
assert.equal(assessmentCalls[0].advance.fundingAsset, 'usdc')
assert.equal(assessmentCalls[0].settlement.protectionNetwork, 'arc-testnet')
assert.equal(assessmentCalls[0].settlement.protectionAsset, 'test-usdc')
