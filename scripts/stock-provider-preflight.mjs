...
export async function stockProviderPreflight(env=process.env,fetcher=fetch){
 ...
 if(!key||!secret){report.checks.independentStockData={status:'NOT_CONFIGURED'};report.blockers.push('Alpaca data credentials and SIP entitlement are not configured in this process')}
