...
const launchV27 = await read('android/app/src/main/res/values-v27/hashpaystream_launch.xml')
assert.match(launchV27, /name="AppTheme\.NoActionBarLaunch" parent="AppTheme\.LaunchBase"/)
assert.match(launchV27, /name="android:windowLightNavigationBar">false/)
