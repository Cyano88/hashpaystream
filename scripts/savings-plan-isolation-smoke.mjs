...
const context={exports:{},...React,getAddress,useXLayerUsdcBalance:()=>wallet,useSavingsRuntimeConfig:()=>config,upfrontXLayerChain:{id:196},http:()=>({}),XLAYER_USDC_ADDRESS:asset,SAVINGS_VAULT_ABI:[],PLAN_ID_PAGE_SIZE:100n,PLAN_READ_BATCH_SIZE:20,nextSavingsRelease:()=>0,
