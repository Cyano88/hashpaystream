...
const record = { id: '0x' + 'aa'.repeat(32), workerUserId: 'worker-user', partnerApplicationId: partners.applications.approved.id, status: 'requested', authorization: { terms: { funder, advanceUsdcAmount: '10', funderRepaymentAmount: '11', stockAsset: env.HASHPAYSTREAM_STOCK_ASSET_ADDRESS } } }
